/**
 * 下载链接： https://ypstatic.cnnb.com.cn/yppage-server/index.html#/downLoad/index?code=UUX9VXN5
 * cron 4 8,19 * * *  
 *  https://ypapp.cnnb.com.cn/yongpai-user/api/duiba/autologin  链接下的userId
 * 更新时间 1.16 自动获取抽奖ID
 */

const yongpai = "2171420671043758205#b64d41f8d11fa9a2#15857322236#朱佳威"//格式为userId#deviceId#支付宝账号#姓名 多账户&
...
async function get_id() {
    ...
    for (let news of res.data.content) {
        if (count >= 10) {
            break; // 如果计数器达到10，跳出循环
        }
        if (news.tb1) {
            if (news.tb1.indexOf("03/fa1ea5a4-cc18-4911-8314-87d175e8da9f.jpg") !== -1 || news.tb1.indexOf("02/d16df66a-af80-4c53-83dd-9723bb78f472.jpg") !== -1) {                
